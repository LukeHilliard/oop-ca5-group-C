 ...
 * cannot serialize certain Java 8 types such as LocalDate which is used to store an employee's date of birth.
 * A TypeAdapter is needed which overrides whenever the parser sees a LocalDate and converts it to a readable type
 *
 */

public class Adaptor extends TypeAdapter<LocalDate> {
